...
import { validateM3NDiagnostics } from './m3n-validate.js'
import type { ScoreDiagnostic } from './notation/diagnostics.js'
import type { ScoreDocument, ScoreEvent, ScoreMeasure } from './notation/score-document.js'
import { needsCjkSpacingCompensation } from './notation/mei-lyrics.js'
import { escapeXml } from './notation/mei-xml.js'
import { projectM3NDocument, type M3NDocumentProjection } from './notation/m3n-document.js'
import { parseM3NSyntaxTree, type M3NSyntaxTree } from './notation/syntax-tree.js'
import { meiDocumentXml, meiKeySignature, scoreHeaderMetadata, type ScoreHeaderMetadata } from './notation/mei-document.js'
import { meiSectionContent, type MeiLayoutNode } from './notation/mei-layout.js'

export type { ScoreHeaderMetadata } from './notation/mei-document.js'
...
export function m3nToMei(source: string, suppliedDocument?: ScoreDocument, context: { projection?: M3NDocumentProjection; syntaxTree?: M3NSyntaxTree } = {}): MeiConversionResult {
  ...
  const lyricSyllables = document.lyrics.map((block) => {
    ...
    const passRange = block.sharedPasses || block.range || block.phrasePasses
